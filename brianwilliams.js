...
var whitelistedUsers     = ['tyler shambora (4merly six-p-tdrop)', 'daniel lerman', 'ryan little', 'cory cummings'];
...
controller.configureSlackApp({
  ...
  scopes: ['bot', 'chat:write:user', 'chat:write:bot', 'channels:read', 'channels:write']
});
